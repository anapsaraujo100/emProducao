    ...
    <nav className="box-border h-[236px] w-[251px] p-2 border-2 ml-16 mr-16 mt-16 drop-shadow-lg...">
      ...
      <ul>
        <li>
          ...
          <label  className="peer-checked/draft:text-orange-500 font-bold ">Tênis</label>
          <div className="hidden peer-checked/tenis:block">Tenis</div>
        </li>
        <li>
          <input id="blusa" className="peer/blusa" type="radio" name="status" />
          <label  className="peer-checked/blusa:text-orange-500 font-bold">Blusa</label>
        ...
        <li>
          ...
          <label className="peer-checked/acessorio:text-orange-500 font-bold">Acessórios</label>
        ...
        <li>
          ...
          <label  className="peer-checked/calcas:text-orange-500 font-bold">Calças</label>
